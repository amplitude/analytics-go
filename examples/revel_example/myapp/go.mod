...
require github.com/amplitude/Amplitude-Go v1.1.0-unpublish
replace github.com/amplitude/Amplitude-Go v1.1.0-unpublish => /Users/xinyi.ye/Desktop/Amplitude-Go/
